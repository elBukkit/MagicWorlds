...
public class MagicWorld {
	...
	private final Map<String, BlockPopulator> blockPopulators = new HashMap<String, BlockPopulator>();
	...
	public void installPopulators(World world) {
		for (Entry<String, BlockPopulator> populator : blockPopulators.entrySet()) {
